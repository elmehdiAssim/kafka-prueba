...
public class UserConsumerConfig {
    ...
    public DefaultErrorHandler errorHandler() {
        ...
        var errorHandle =  new DefaultErrorHandler(
                publishingRecoverer(),
                // fixedBackOff
                expBackOff
        );

        // exceptionsToIgnoreList.forEach(errorHandle::addNotRetryableExceptions);
        exceptionsToRetryList.forEach(errorHandle::addRetryableExceptions);
